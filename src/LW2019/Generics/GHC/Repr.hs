...
instance Generic BookInfo where
  ...
  to (K1 name :*: K1 isbn :*: K1 price) = BookInfo name isbn price
  from (BookInfo name isbn price) = K1 name :*: K1 isbn :*: K1 price
...
type Tree12Rep a
   = U1 :+: (K1 R a :*: K1 R (Tree12 a)) :+: (K1 R a :*: K1 R (Tree12 a) :*: K1 R (Tree12 a))
